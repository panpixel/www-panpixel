                        ...
                        <div class="portfolio-left bk-portfolio-details">
                            <div class="portfolio-main-info">
                                ...
                                <div class="portfolio-content mt--75 mb--75 mt_md--40 mb_md--40 mt_sm--40 mb_sm--40">
                                    <h5 class="heading heading-h6">Fotografia produktowa</h5>
                                    <div class="desc mt--20">
                                        <p class="bk_pra">Sesja zdjęciowa dla firmy Fornit, wykonana w siedzibie</p>
                                    </div>
                                </div>
                                <!-- Start Details List -->
                                <div class="portfolio-details-list">
                                    ...
                                    <div class="details-list">
                                        <label>Klient</label>
                                        <span>Fornit ⋆ designe.furniture.factory</span>
                                    </div>

                                    <div class="details-list">
                                        <label>Kategoria</label>
                                        <span>
                                            <n-link to="">fotografia produktowa</n-link>
                                        </span>
                                    </div>
                    ...
                    <div class="col-lg-8 mt_md--40 mt_sm--40 pl--100 pl_md--15 pl_sm--15 pr_md--15 pr_sm--15">
                        <div class="portfolio-right portfolio-details-gallery text-center text-md-right">
                            ...
                            <div class="portfolio-image mb--50">
                               <img class="w-100" src="/img/fotografia.produktowa/fotografia-reklamowa-producent-mebli.Fornit.jpg" alt="Fornit - producent mebli">
                            ...
                            <!-- Start Portfolio Image -->
                            <div class="portfolio-image mb--50">
                                <img class="w-100" src="/img/fotografia.produktowa/fotografia-produktowa-producent-mebli.Fornit.jpg" alt="Fornit - producent mebli">
                                <div class="cation-text ptb--20 bg_color--5 text-center">
                                    <p class="bk_pra">Produkcja mebli biurowych</p>
                                </div>
                            </div>
